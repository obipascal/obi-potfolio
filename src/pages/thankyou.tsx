				...
				<div className="h-full">
					...
					<div className="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between">
						...
						<div className="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
							<Formik initialValues={initVals} onSubmit={() => {}} validationSchema={ReviewValidationSchema}>
								{({ isSubmitting, values, handleChange, handleSubmit }) => (
									<Form className="px-8 text-slate-900 dark:text-light rounded-md shadow-sm bg-white dark:bg-slate-800 py-5" onSubmit={handleSubmit}>
										...
										<div className="text-center lg:text-left">
											<h1 className="p-2 font-bold md:text-2xl xs:text-md text-green-600 flex flex-col items-center text-center py-8 my-8">
												<IconHandWave width={"2em"} height={"2em"} /> Thank you! Very much your review has been recieved successfully.
											</h1>
										</div>
										{/* <!-- Login button --> */}
										<div className="text-center lg:text-left">
