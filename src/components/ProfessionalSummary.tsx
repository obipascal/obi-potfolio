...
export default function ProfessionalSummary() {
	return (
		<div className="p-3 w-full">
			<p className="tracking-wide block text-center">
				...
				development, using languages such as HTML, CSS, JavaScript, PHP, and SQL. I am a detail-oriented team player who is committed to continuously improving my skills and staying up-to-date with
